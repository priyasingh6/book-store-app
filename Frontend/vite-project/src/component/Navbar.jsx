...
<li><a href="/">Home</a></li>
  ...
  return (
   <> <div className={`max-w-screen-2xl mx-auto container md:px-20 px-3 text-gray-700 fixed top-0 z-50 left-0 right-0 
    ${sticky
      ? " sticky-navbar shadow-md bg-transparent backdrop-blur-sm border-b border-gray-200 duration-300 transition-all ease-in-out" : "" }`}
      >
